...
CREATE INDEX IF NOT EXISTS idx_support_video_calls_ticket_id ON support_video_calls(ticket_id);
CREATE INDEX IF NOT EXISTS idx_support_video_calls_agent_id ON support_video_calls(agent_id);
