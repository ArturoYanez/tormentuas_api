...
CREATE INDEX IF NOT EXISTS idx_internal_chat_members_room_id ON internal_chat_members(room_id);
CREATE INDEX IF NOT EXISTS idx_internal_chat_members_agent_id ON internal_chat_members(agent_id);
