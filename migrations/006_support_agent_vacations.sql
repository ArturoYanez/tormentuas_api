...
CREATE INDEX idx_support_agent_vacations_agent_id ON support_agent_vacations(agent_id);
CREATE INDEX idx_support_agent_vacations_dates ON support_agent_vacations(start_date, end_date);
